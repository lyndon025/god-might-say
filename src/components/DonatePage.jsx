...
const DonatePage = () => {
  return (
    <div className="flex-1 w-full overflow-y-auto flex flex-col items-center justify-start p-6 pb-24 space-y-10 bg-background dark:bg-light-background text-primary-text dark:text-light-primary-text min-h-screen">
      <div className="max-w-2xl w-full text-center">
        <h2 className="text-4xl font-serif mb-4">Support the Mission</h2>

        <p className="text-secondary-text dark:text-light-secondary-text mb-12">
        ...
        <div className="p-6 bg-surface dark:bg-light-surface rounded-lg">
          ...
          <p className="mt-4 text-secondary-text dark:text-light-secondary-text">Scan with your Maya app to donate.</p>
        </div>
      </div>
